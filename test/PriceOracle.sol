...
contract PriceOracle is IexecDoracle, Ownable, IOracleConsumer, IERC2362
{
	...
	public IexecDoracle(_iexecproxy)
	{}
	...
	{
		// Parse results
		bytes memory results = _iexecDoracleGetVerifiedResult(_callID);
		(uint256 date, string memory details, int256 value) = abi.decode(results, (uint256, string, int256));
